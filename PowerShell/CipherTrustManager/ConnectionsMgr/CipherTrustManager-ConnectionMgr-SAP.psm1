...
#This project mirrors the "Connection Manager - oci Connections" section of the API Playground of CM (/playground_v2/api/Connection Manager/SAP Data Custodian Connections)
...
function New-CMSAPConnection{
    ...
    Write-Debug "Creating an SAP Data Custodian OCI Connection in CM"
    $endpoint = $CM_Session.REST_URL + $target_uri
    Write-Debug "Endpoint: $($endpoint)"
