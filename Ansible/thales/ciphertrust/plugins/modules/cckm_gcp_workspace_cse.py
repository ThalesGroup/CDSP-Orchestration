...
from ansible_collections.thales.ciphertrust.plugins.module_utils.cckm_gcp import performGCPWorkspaceEndpointOperation
...
- name: "Create GCP Workspace CSE"
  thales.ciphertrust.cckm_gcp_workspace_cse:
    localNode:
